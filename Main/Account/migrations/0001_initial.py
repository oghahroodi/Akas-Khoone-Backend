# Generated by Django 2.1 on 2018-09-12 11:04
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('userFollowed', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='followed2', to=settings.AUTH_USER_MODEL)),
                ('userFollowing', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='following2', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='ForgetPassword',
