...
class Person(models.Model):
    ...
    phoneNumber = models.CharField(validators=[phone_regex], max_length=17, blank=True,  unique=True) # validators should be a list
    validation = models.BooleanField(default=False)
    accountCreationDate = models.DateTimeField('date published', default=timezone.now)
    user_regex = RegexValidator(regex=r"^[a-zA-Z0-9_]*$",message="Username can only contain numbers,charachters, _ and .")
